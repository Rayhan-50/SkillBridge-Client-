...
export function BookingModal({ tutor, children }: BookingModalProps) {
    ...
    return (
        <Dialog open={open} onOpenChange={(isOpen) => {
            ...
            <DialogTrigger
                render={React.isValidElement(children) ? (children as React.ReactElement) : <Button />}
            >
                                                    ...
                                                    <PopoverTrigger
                                                        render={
                                                            <button
                                                                type="button"
                                                                className={cn(
                                                                    "w-full inline-flex items-center justify-start text-left font-normal h-12 rounded-[12px] border border-slate-200 dark:border-slate-700 bg-white dark:bg-[#0f172a]/50 hover:bg-slate-50 dark:hover:bg-slate-800 px-3 text-sm",
