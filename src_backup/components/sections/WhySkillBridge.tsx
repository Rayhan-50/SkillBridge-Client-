        ...
        >
          {features.map((f, i) => (
            <motion.div
              ...
              variants={fadeUp}
              custom={i * 0.1}
              className="group relative p-8 glass-card rounded-2xl hover:border-primary/30 transition-all duration-500 hover:-translate-y-2 overflow-hidden flex flex-col h-full"
            >
